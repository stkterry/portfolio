...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Looper; });
...
function () {
  ...
  _createClass(Looper, [{
    ...
    key: "drawNoiseLoop",
    value: function drawNoiseLoop(noise, cx, cy, radius) {
      var r, x, y, xoff, yoff;
      this.ctx.beginPath();
    ...
    key: "getNoiseLoop",
    value: function getNoiseLoop(noise, radius) {
      var a, x, y, r, xoff, yoff;
    ...
    key: "drawNoiseLoop2",
    value: function drawNoiseLoop2(cx, cy) {
      var x, y;
    ...
    value: function drawCircle(c) {
      ...
      this.ctx.stroke();
      this.ctx.fill();
      this.ctx.closePath(); // get connecting line?

      var xDiff = x - this.canvas.width / 2;
      var yDiff = y - this.canvas.height / 2;
      var m = yDiff / xDiff;
...
/***/ "./src/app/js/jquery.scrolly.min.js":
/*!******************************************!*\
  !*** ./src/app/js/jquery.scrolly.min.js ***!
  \******************************************/
/*! no static exports found */
...
var jQuery = __webpack_require__(/*! ./app/js/jquery.min.js */ "./src/app/js/jquery.min.js");

var scrolly = __webpack_require__(/*! ./app/js/jquery.scrolly.min.js */ "./src/app/js/jquery.scrolly.min.js");

__webpack_require__(/*! ./app/js/main */ "./src/app/js/main.js");

__webpack_require__(/*! ./app/js/util */ "./src/app/js/util.js");

__webpack_require__(/*! ./app/js/breakpoints.min.js */ "./src/app/js/breakpoints.min.js");

__webpack_require__(/*! ./app/js/browser.min.js */ "./src/app/js/browser.min.js");
